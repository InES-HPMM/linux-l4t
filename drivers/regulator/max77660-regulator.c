...
static struct max77660_regulator_info
	...
	REGULATOR_BUCK(BUCK1, SDX, BUCK1,  600000, 1500000, 12500),
	REGULATOR_BUCK(BUCK2, SDX, BUCK2,  600000, 1500000, 12500),
	REGULATOR_BUCK(BUCK3, SDX, BUCK3,  600000, 3787500, 12500),
	REGULATOR_BUCK(BUCK4, SDX, BUCK4,  800000, 1500000, 12500),
	REGULATOR_BUCK(BUCK5, SDX, BUCK5,  600000, 3787500, 12500),
	REGULATOR_BUCK(BUCK6, SD1, BUCK6, 1000000, 4000000, 12500),
	REGULATOR_BUCK(BUCK7, SD1, BUCK7, 1000000, 4000000, 12500),
