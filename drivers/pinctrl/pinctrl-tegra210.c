...
enum tegra_mux_dt {
	...
	TEGRA_MUX_DT_VGP5,
	TEGRA_MUX_DT_VGP6,
	TEGRA_MUX_DT_VIMCLK_ALT3,
	TEGRA_MUX_DT_VIMCLK2_ALT3,
	TEGRA_MUX_DT_SATA,
	TEGRA_MUX_DT_CCLA,
	TEGRA_MUX_DT_JTAG_RTCK,
	TEGRA_MUX_DT_SYS,
	TEGRA_MUX_DT_PE,
	TEGRA_MUX_DT_PE0,
	TEGRA_MUX_DT_PE1,
...
static const struct tegra_pingroup tegra210_groups[] = {
	...
	PINGROUP(uart2_rx_pg1,		UB3,		I2S4,		SPDIF,		UART,		UB3,		0x30f8,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_tx_pg0,		UB3,		I2S4,		SPDIF,		UART,		UB3,		0x30f4,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_rts_pg2,		UB3,		I2S4,		RSVD3,		UART,		UB3,		0x30fc,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_cts_pg3,		UB3,		I2S4,		RSVD3,		UART,		UB3,		0x3100,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(uart4_tx_pi4,		UD3,		UART,		RSVD3,		RSVD4,		UD3,		0x3114,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_rx_pi5,		UD3,		UART,		RSVD3,		RSVD4,		UD3,		0x3118,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_rts_pi6,		UD3,		UART,		RSVD3,		RSVD4,		UD3,		0x311c,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_cts_pi7,		UD3,		UART,		RSVD3,		RSVD4,		UD3,		0x3120,  Y,	12,	-1,	N,	N),
