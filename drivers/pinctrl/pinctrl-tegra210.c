...
static const struct tegra_pingroup tegra210_groups[] = {
	...
	PINGROUP(sdmmc1_clk_pm0,	SDMMC1,		RSVD2,		RSVD3,		RSVD4,		0x3000,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_cmd_pm1,	SDMMC1,		SPI3,		RSVD3,		RSVD4,		0x3004,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat3_pm2,	SDMMC1,		SPI3,		RSVD3,		RSVD4,		0x3008,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat2_pm3,	SDMMC1,		SPI3,		RSVD3,		RSVD4,		0x300c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat1_pm4,	SDMMC1,		SPI3,		RSVD3,		RSVD4,		0x3010,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc1_dat0_pm5,	SDMMC1,		RSVD2,		RSVD3,		RSVD4,		0x3014,  Y,	12,	 9,	Y,	N),
	PINGROUP(uart2_rx_pg1,		UB3,		I2S4,		SPDIF,		UART_APE,	0x30f8,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_tx_pg0,		UB3,		I2S4,		SPDIF,		UART_APE,	0x30f4,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_rts_pg2,		UB3,		I2S4,		RSVD3,		UART_APE,	0x30fc,  Y,	12,	-1,	N,	N),
	PINGROUP(uart2_cts_pg3,		UB3,		I2S4,		RSVD3,		UART_APE,	0x3100,  Y,	12,	-1,	N,	N),
	PINGROUP(uart3_tx_pd1,		UC3,		SPI4,		RSVD3,		RSVD4,		0x3104,  Y,	12,	-1,	N,	N),
	PINGROUP(uart3_rx_pd2,		UC3,		SPI4,		RSVD3,		RSVD4,		0x3108,  Y,	12,	-1,	N,	N),
	PINGROUP(uart3_cts_pd4,		UC3,		SPI4,		RSVD3,		RSVD4,		0x3110,  Y,	12,	-1,	N,	N),
	PINGROUP(uart3_rts_pd3,		UC3,		SPI4,		RSVD3,		RSVD4,		0x310c,  Y,	12,	-1,	N,	N),
	PINGROUP(gen1_i2c_scl_pj1,	I2C1,		RSVD2,		RSVD3,		RSVD4,		0x30bc,  Y,	12,	-1,	N,	Y),
	PINGROUP(gen1_i2c_sda_pj0,	I2C1,		RSVD2,		RSVD3,		RSVD4,		0x30c0,  Y,	12,	-1,	N,	Y),
	PINGROUP(dap4_fs_pj4,		I2S4,		RSVD2,		RSVD3,		RSVD4,		0x3144,  Y,	12,	-1,	N,	N),
	PINGROUP(dap4_din_pj5,		I2S4,		RSVD2,		RSVD3,		RSVD4,		0x3148,  Y,	12,	-1,	N,	N),
	PINGROUP(dap4_dout_pj6,		I2S4,		RSVD2,		RSVD3,		RSVD4,		0x314c,  Y,	12,	-1,	N,	N),
	PINGROUP(dap4_sclk_pj7,		I2S4,		RSVD2,		RSVD3,		RSVD4,		0x3150,  Y,	12,	-1,	N,	N),
	PINGROUP(pk0,			IQC0,		I2S5,		RSVD3,		RSVD4,		0x3254,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk1,			IQC0,		I2S5,		RSVD3,		RSVD4,		0x3258,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk3,			IQC0,		I2S5,		RSVD3,		RSVD4,		0x3260,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk4,			IQC1,		RSVD2,		RSVD3,		RSVD4,		0x3264,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk2,			IQC0,		I2S5,		RSVD3,		RSVD4,		0x325c,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk7,			IQC1,		RSVD2,		RSVD3,		RSVD4,		0x3270,  Y,	12,	 9,	Y,	N),
	PINGROUP(gen2_i2c_scl_pj2,	I2C2,		RSVD2,		RSVD3,		RSVD4,		0x30c4,  Y,	12,	-1,	N,	Y),
	PINGROUP(gen2_i2c_sda_pj3,	I2C2,		RSVD2,		RSVD3,		RSVD4,		0x30c8,  Y,	12,	-1,	N,	Y),
	PINGROUP(cam1_mclk_ps0,		EXTPERIPH3,	RSVD2,		RSVD3,		RSVD4,		0x3154,  Y,	12,	-1,	N,	N),
	PINGROUP(cam2_mclk_ps1,		EXTPERIPH3,	RSVD2,		RSVD3,		RSVD4,		0x3158,  Y,	12,	-1,	N,	N),
	PINGROUP(cam_i2c_scl_ps2,	I2C3,		I2CVI,		RSVD3,		RSVD4,		0x30d4,  Y,	12,	-1,	N,	Y),
	PINGROUP(cam_i2c_sda_ps3,	I2C3,		I2CVI,		RSVD3,		RSVD4,		0x30d8,  Y,	12,	-1,	N,	Y),
	PINGROUP(jtag_rtck,		JTAG_RTCK,	RSVD2,		RSVD3,		RSVD4,		0x315c,  Y,	12,	-1,	N,	N),
	PINGROUP(pwr_i2c_scl_py3,	I2CPWR,		RSVD2,		RSVD3,		RSVD4,		0x30dc,  Y,	12,	-1,	N,	Y),
	PINGROUP(pwr_i2c_sda_py4,	I2CPWR,		RSVD2,		RSVD3,		RSVD4,		0x30e0,  Y,	12,	-1,	N,	Y),
	PINGROUP(clk_32k_out_py5,	SOC,		BLINK,		RSVD3,		RSVD4,		0x3164,  Y,	12,	-1,	N,	N),
	PINGROUP(core_pwr_req,		CORE,		RSVD2,		RSVD3,		RSVD4,		0x317c,  Y,	12,	-1,	N,	N),
	PINGROUP(cpu_pwr_req,		CPU,		RSVD2,		RSVD3,		RSVD4,		0x3170,  Y,	12,	-1,	N,	N),
	PINGROUP(pwr_int_n,		PMI,		RSVD2,		RSVD3,		RSVD4,		0x3174,  Y,	12,	-1,	N,	N),
	PINGROUP(clk_32k_in,		CLK,		RSVD2,		RSVD3,		RSVD4,		0x3160,  Y,	12,	-1,	N,	N),
	PINGROUP(dap1_fs_pb0,		I2S1,		RSVD2,		RSVD3,		RSVD4,		0x3124,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_din_pb1,		I2S1,		RSVD2,		RSVD3,		RSVD4,		0x3128,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_dout_pb2,		I2S1,		RSVD2,		RSVD3,		RSVD4,		0x312c,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap1_sclk_pb3,		I2S1,		RSVD2,		RSVD3,		RSVD4,		0x3130,  Y,	12,	 9,	Y,	N),
	PINGROUP(spdif_in_pcc3,		SPDIF,		RSVD2,		RSVD3,		RSVD4,		0x31a4,  Y,	12,	-1,	N,	N),
	PINGROUP(spdif_out_pcc2,	SPDIF,		RSVD2,		RSVD3,		RSVD4,		0x31a0,  Y,	12,	-1,	N,	N),
	PINGROUP(dap2_fs_paa0,		I2S2,		RSVD2,		RSVD3,		RSVD4,		0x3134,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_din_paa2,		I2S2,		RSVD2,		RSVD3,		RSVD4,		0x3138,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_dout_paa3,	I2S2,		RSVD2,		RSVD3,		RSVD4,		0x313c,  Y,	12,	 9,	Y,	N),
	PINGROUP(dap2_sclk_paa1,	I2S2,		RSVD2,		RSVD3,		RSVD4,		0x3140,  Y,	12,	 9,	Y,	N),
	PINGROUP(dvfs_pwm_pbb1,		RSVD1,		CLDVFS,		SPI3,		RSVD4,		0x3184,  Y,	12,	-1,	N,	N),
	PINGROUP(gpio_x1_aud_pbb3,	RSVD1,		RSVD2,		SPI3,		RSVD4,		0x318c,  Y,	12,	-1,	N,	N),
	PINGROUP(gpio_x3_aud_pbb4,	RSVD1,		RSVD2,		SPI3,		RSVD4,		0x3190,  Y,	12,	-1,	N,	N),
	PINGROUP(dvfs_clk_pbb2,		RSVD1,		CLDVFS,		SPI3,		RSVD4,		0x3188,  Y,	12,	-1,	N,	N),
	PINGROUP(sdmmc3_clk_pp0,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x301c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_cmd_pp1,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x3020,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat0_pp5,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x3024,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat1_pp4,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x3028,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat2_pp3,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x302c,  Y,	12,	 9,	Y,	N),
	PINGROUP(sdmmc3_dat3_pp2,	SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x3030,  Y,	12,	 9,	Y,	N),
	PINGROUP(pex_l0_rst_n_pa0,	PE0,		RSVD2,		RSVD3,		RSVD4,		0x3038,  Y,	12,	-1,	N,	Y),
	PINGROUP(pex_l0_clkreq_n_pa1,	PE0,		RSVD2,		RSVD3,		RSVD4,		0x303c,  Y,	12,	-1,	N,	Y),
	PINGROUP(pex_wake_n_pa2,	PE,		RSVD2,		RSVD3,		RSVD4,		0x3040,  Y,	12,	-1,	N,	Y),
	PINGROUP(pex_l1_rst_n_pa3,	PE1,		RSVD2,		RSVD3,		RSVD4,		0x3044,  Y,	12,	-1,	N,	Y),
	PINGROUP(pex_l1_clkreq_n_pa4,	PE1,		RSVD2,		RSVD3,		RSVD4,		0x3048,  Y,	12,	-1,	N,	Y),
	PINGROUP(hdmi_cec_pcc0,		CEC,		RSVD2,		RSVD3,		RSVD4,		0x3198,  Y,	12,	-1,	N,	Y),
	PINGROUP(sata_led_active_pa5,	SATA,		RSVD2,		RSVD3,		RSVD4,		0x304c,  Y,	12,	-1,	N,	N),
	PINGROUP(spi1_mosi_pc0,		SPI1,		RSVD2,		RSVD3,		RSVD4,		0x3050,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_miso_pc1,		SPI1,		RSVD2,		RSVD3,		RSVD4,		0x3054,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_sck_pc2,		SPI1,		RSVD2,		RSVD3,		RSVD4,		0x3058,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_cs0_pc3,		SPI1,		RSVD2,		RSVD3,		RSVD4,		0x305c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi1_cs1_pc4,		SPI1,		RSVD2,		RSVD3,		RSVD4,		0x3060,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_mosi_pb4,		SPI2,		DTV,		RSVD3,		RSVD4,		0x3064,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_miso_pb5,		SPI2,		DTV,		RSVD3,		RSVD4,		0x3068,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_sck_pb6,		SPI2,		DTV,		RSVD3,		RSVD4,		0x306c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_cs0_pb7,		SPI2,		DTV,		RSVD3,		RSVD4,		0x3070,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi2_cs1_pdd0,		SPI2,		RSVD2,		RSVD3,		RSVD4,		0x3074,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_mosi_pc7,		SPI4,		RSVD2,		RSVD3,		RSVD4,		0x3078,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_miso_pd0,		SPI4,		RSVD2,		RSVD3,		RSVD4,		0x307c,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_sck_pc5,		SPI4,		RSVD2,		RSVD3,		RSVD4,		0x3080,  Y,	12,	 9,	Y,	N),
	PINGROUP(spi4_cs0_pc6,		SPI4,		RSVD2,		RSVD3,		RSVD4,		0x3084,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_sck_pee0,		QSPI,		RSVD2,		RSVD3,		RSVD4,		0x3088,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_cs_n_pee1,	QSPI,		RSVD2,		RSVD3,		RSVD4,		0x308c,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io0_pee2,		QSPI,		RSVD2,		RSVD3,		RSVD4,		0x3090,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io1_pee3,		QSPI,		RSVD2,		RSVD3,		RSVD4,		0x3094,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io2_pee4,		QSPI,		RSVD2,		RSVD3,		RSVD4,		0x3098,  Y,	12,	 9,	Y,	N),
	PINGROUP(qspi_io3_pee5,		QSPI,		RSVD2,		RSVD3,		RSVD4,		0x309c,  Y,	12,	 9,	Y,	N),
	PINGROUP(dmic1_clk_pe0,		DMIC1,		I2S3,		RSVD3,		RSVD4,		0x30a4,  Y,	12,	-1,	N,	N),
	PINGROUP(dmic1_dat_pe1,		DMIC1,		I2S3,		RSVD3,		RSVD4,		0x30a8,  Y,	12,	-1,	N,	N),
	PINGROUP(dmic2_clk_pe2,		DMIC2,		I2S3,		RSVD3,		RSVD4,		0x30ac,  Y,	12,	-1,	N,	N),
	PINGROUP(dmic2_dat_pe3,		DMIC2,		I2S3,		RSVD3,		RSVD4,		0x30b0,  Y,	12,	-1,	N,	N),
	PINGROUP(dmic3_clk_pe4,		DMIC3,		I2S5,		RSVD3,		RSVD4,		0x30b4,  Y,	12,	-1,	N,	N),
	PINGROUP(dmic3_dat_pe5,		DMIC3,		I2S5,		RSVD3,		RSVD4,		0x30b8,  Y,	12,	-1,	N,	N),
	PINGROUP(gen3_i2c_scl_pf0,	I2C3,		RSVD2,		RSVD3,		RSVD4,		0x30cc,  Y,	12,	-1,	N,	Y),
	PINGROUP(gen3_i2c_sda_pf1,	I2C3,		RSVD2,		RSVD3,		RSVD4,		0x30d0,  Y,	12,	-1,	N,	Y),
	PINGROUP(uart1_tx_pu0,		UA3,		RSVD2,		RSVD3,		RSVD4,		0x30e4,  Y,	12,	-1,	N,	N),
	PINGROUP(uart1_rx_pu1,		UA3,		RSVD2,		RSVD3,		RSVD4,		0x30e8,  Y,	12,	-1,	N,	N),
	PINGROUP(uart1_rts_pu2,		UA3,		RSVD2,		RSVD3,		RSVD4,		0x30ec,  Y,	12,	-1,	N,	N),
	PINGROUP(uart1_cts_pu3,		UA3,		RSVD2,		RSVD3,		RSVD4,		0x30f0,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_tx_pi4,		UD3,		UART_APE,	RSVD3,		RSVD4,		0x3114,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_rx_pi5,		UD3,		UART_APE,	RSVD3,		RSVD4,		0x3118,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_rts_pi6,		UD3,		UART_APE,	RSVD3,		RSVD4,		0x311c,  Y,	12,	-1,	N,	N),
	PINGROUP(uart4_cts_pi7,		UD3,		UART_APE,	RSVD3,		RSVD4,		0x3120,  Y,	12,	-1,	N,	N),
	PINGROUP(batt_bcl,		BCL,		RSVD2,		RSVD3,		RSVD4,		0x3168,  Y,	12,	-1,	N,	Y),
	PINGROUP(clk_req,		SYS,		RSVD2,		RSVD3,		RSVD4,		0x316c,  Y,	12,	-1,	N,	N),
	PINGROUP(shutdown,		SHUTDOWN,	RSVD2,		RSVD3,		RSVD4,		0x3178,  Y,	12,	-1,	N,	N),
	PINGROUP(aud_mclk_pbb0,		AUD,		RSVD2,		RSVD3,		RSVD4,		0x3180,  Y,	12,	-1,	N,	N),
	PINGROUP(pcc7,			RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3194,  Y,	12,	-1,	N,	Y),
	PINGROUP(hdmi_int_dp_hpd_pcc1,	DP,		RSVD2,		RSVD3,		RSVD4,		0x319c,  Y,	12,	-1,	N,	Y),
	PINGROUP(wifi_en_ph0,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31b4,  Y,	12,	-1,	N,	N),
	PINGROUP(wifi_rst_ph1,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31b8,  Y,	12,	-1,	N,	N),
	PINGROUP(wifi_wake_ap_ph2,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31bc,  Y,	12,	-1,	N,	N),
	PINGROUP(ap_wake_bt_ph3,	RSVD1,		UB3,		SPDIF,		RSVD4,		0x31c0,  Y,	12,	-1,	N,	N),
	PINGROUP(bt_rst_ph4,		RSVD1,		UB3,		SPDIF,		RSVD4,		0x31c4,  Y,	12,	-1,	N,	N),
	PINGROUP(bt_wake_ap_ph5,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31c8,  Y,	12,	-1,	N,	N),
	PINGROUP(ap_wake_nfc_ph7,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31cc,  Y,	12,	-1,	N,	N),
	PINGROUP(nfc_en_pi0,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31d0,  Y,	12,	-1,	N,	N),
	PINGROUP(nfc_int_pi1,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31d4,  Y,	12,	-1,	N,	N),
	PINGROUP(gps_en_pi2,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31d8,  Y,	12,	-1,	N,	N),
	PINGROUP(gps_rst_pi3,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x31dc,  Y,	12,	-1,	N,	N),
	PINGROUP(cam_rst_ps4,		VGP1,		RSVD2,		RSVD3,		RSVD4,		0x31e0,  Y,	12,	-1,	N,	N),
	PINGROUP(cam_af_en_ps5,	 	VIMCLK_ALT3,	VGP2,		RSVD3,		RSVD4,		0x31e4,  Y,	12,	-1,	N,	N),
	PINGROUP(cam_flash_en_ps6,	VIMCLK_ALT3,	VGP3,		RSVD3,		RSVD4,		0x31e8,  Y,	12,	-1,	N,	N),
	PINGROUP(cam1_pwdn_ps7,		VGP4,		RSVD2,		RSVD3,		RSVD4,		0x31ec,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(lcd_te_py2,		DCA,		RSVD2,		RSVD3,		RSVD4,		0x31f8,  Y,	12,	-1,	N,	N),
	PINGROUP(lcd_bl_pwm_pv0,	DCA,		PM3,		SOR0,		RSVD4,		0x31fc,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(lcd_gpio2_pv4,		DCB,		PM3,		RSVD3,		SOR1,		0x320c,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(modem_wake_ap_px0,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x321c,  Y,	12,	-1,	N,	N),
	PINGROUP(touch_int_px1,		RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3220,  Y,	12,	-1,	N,	N),
	PINGROUP(motion_int_px2,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3224,  Y,	12,	-1,	N,	N),
	PINGROUP(als_prox_int_px3,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3228,  Y,	12,	-1,	N,	N),
	PINGROUP(temp_alert_px4,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x322c,  Y,	12,	-1,	N,	N),
	PINGROUP(button_power_on_px5,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3230,  Y,	12,	-1,	N,	N),
	PINGROUP(button_vol_up_px6,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3234,  Y,	12,	-1,	N,	N),
	PINGROUP(button_vol_down_px7,	RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3238,  Y,	12,	-1,	N,	N),
	...
	PINGROUP(pe6,			RSVD1,		I2S5,		PM3,		RSVD4,		0x3248,  Y,	12,	-1,	N,	N),
	PINGROUP(pe7,			RSVD1,		I2S5,		PM3,		RSVD4,		0x324c,  Y,	12,	-1,	N,	N),
	PINGROUP(ph6,			RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3250,  Y,	12,	-1,	N,	N),
	PINGROUP(pk5,			IQC1,		RSVD2,		RSVD3,		RSVD4,		0x3268,  Y,	12,	 9,	Y,	N),
	PINGROUP(pk6,			IQC1,		RSVD2,		RSVD3,		RSVD4,		0x326c,  Y,	12,	 9,	Y,	N),
	PINGROUP(pl0,			RSVD1,		RSVD2,		RSVD3,		RSVD4,		0x3274,  Y,	12,	 9,	Y,	N),
	PINGROUP(pl1,			SOC,		RSVD2,		RSVD3,		RSVD4,		0x3278,  Y,	12,	 9,	Y,	N),
	PINGROUP(pz0,			VIMCLK2_ALT3,	RSVD2,		RSVD3,		RSVD4,		0x327c,  Y,	12,	-1,	N,	N),
	PINGROUP(pz1,			VIMCLK2_ALT3,	SDMMC1,		RSVD3,		RSVD4,		0x3280,  Y,	12,	-1,	N,	N),
	PINGROUP(pz2,			SDMMC3,		CCLA,		RSVD3,		RSVD4,		0x3284,  Y,	12,	-1,	N,	N),
	PINGROUP(pz3,			SDMMC3,		RSVD2,		RSVD3,		RSVD4,		0x3288,  Y,	12,	-1,	N,	N),
	PINGROUP(pz4,			SDMMC1,		RSVD2,		RSVD3,		RSVD4,		0x328c,  Y,	12,	-1,	N,	N),
	PINGROUP(pz5,			SOC,		RSVD2,		RSVD3,		RSVD4,		0x3290,  Y,	12,	-1,	N,	N),
	PINGROUP(usb_vbus_en0_pcc4,	USB,		RSVD2,		RSVD3,		RSVD4,		0x31a8,  Y,	12,	-1,	N,	Y),
	PINGROUP(usb_vbus_en1_pcc5,	USB,		RSVD2,		RSVD3,		RSVD4,		0x31ac,  Y,	12,	-1,	N,	Y),
	PINGROUP(dp_hpd0_pcc6,		DP,		RSVD2,		RSVD3,		RSVD4,		0x31b0,  Y,	12,	-1,	N,	N),
