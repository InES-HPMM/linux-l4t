...
#define WIFI_PLAT_NAME		"bcmdhd_wlan2_"
#define WIFI_PLAT_NAME2		"bcm4329_wlan2_"
#define WIFI_PLAT_EXT		"bcmdhd_wifi2_platform"
...
#define ARDBEG_WIFI_MAC_ADDR_FILE	"/mnt/factory/wifi/wifi2_mac.txt"
...
static int wifi_plat_dev_drv_probe(struct platform_device *pdev)
{
	...
	if (pdev->dev.of_node) {
		...
		if (resource == NULL)
#ifdef BCMDHD2
			resource = platform_get_resource_byname(pdev, IORESOURCE_IRQ, "bcm4329_wlan2_irq");
#else
...
#else
	dt_node = of_find_compatible_node(NULL, NULL, "nvidia,tegra-bcmdhd2-wlan");
#endif
