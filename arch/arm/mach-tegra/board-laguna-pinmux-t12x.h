...
static __initdata struct tegra_pingroup_config laguna_pinmux_common[] = {
	...
	GPIO_PINMUX(GPIO_PI7, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PC7, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PI0, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(PEX_L1_CLKREQ_N, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(PEX_L1_RST_N, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(USB_VBUS_EN2, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PFF2, PULL_UP, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(KB_ROW13, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(KB_ROW14, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_ROW16, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_ROW17, NORMAL, NORMAL, OUTPUT, DISABLE),
...
static struct gpio_init_pin_info init_gpio_mode_laguna_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PDD5, true, 0),
