...
static struct tegra11_emc_table e1611_h5tc4g63afr_rda_table[] = {
	{
		0x41,       /* Rev 4.0.3 */
...
static struct tegra11_emc_pdata e1611_h5tc4g63afr_rda_pdata = {
	.description = "e1611_h5tc4g63afr_rda",
	.tables = e1611_h5tc4g63afr_rda_table,
	.num_tables = ARRAY_SIZE(e1611_h5tc4g63afr_rda_table),
};
...
static struct tegra11_emc_pdata *dalmore_get_emc_data(void)
{
	...
	if (board_info.board_id == BOARD_E1611 && tegra_sku_id == 0x4)
		return &e1611_h5tc4g63afr_rda_pdata;
