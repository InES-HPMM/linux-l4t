...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("msenc",   -1,  0, 1, KHZ,       68000, 102000, 136000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),
	CORE_DVFS("msenc",   -1,  1, 1, KHZ,       81600, 136000, 204000, 204000, 204000, 204000, 408000, 408000, 408000, 408000),
	CORE_DVFS("tsec",    -1,  0, 1, KHZ,      136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("tsec",    -1,  1, 1, KHZ,      136000, 204000, 384000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("host1x",  -1,  0, 1, KHZ,      102000, 102000, 204000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),
	...
	CORE_DVFS("sbus",    -1,  0, 1, KHZ,      102000, 102000, 102000, 102000, 204000, 384000, 384000, 408000, 408000, 408000),
...
#else
	CORE_DVFS("cbus",    -1,  0, 1, KHZ,      115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	...
	CORE_DVFS("dsia",  -1, -1, 1, KHZ,        252000, 429600, 429600, 429600, 429600, 429600, 429600, 429600, 429600, 429600),
	CORE_DVFS("dsib",  -1, -1, 1, KHZ,        252000, 429600, 429600, 429600, 429600, 429600, 429600, 429600, 429600, 429600),
	CORE_DVFS("hdmi",  -1, -1, 1, KHZ,        111300, 111300, 111300, 135600, 173200, 212300, 270000, 270000, 270000, 270000),

	CORE_DVFS("pll_m",  -1,  0, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c",  -1,  0, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c2", -1,  0, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c3", -1,  0, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
