...
static struct cpu_cvb_dvfs cpu_cvb_dvfs_table[] = {
	{
		...
		.cvb_table = {
			...
			{ 408000, { 1439677,  -58175,   1228}, {  851885,    0,    0} },
			{ 510000, { 1485902,  -60005,   1228}, {  859934,    0,    0} },
			{ 612000, { 1534501,  -61835,   1228}, {  870653,    0,    0} },
			{ 714000, { 1585472,  -63665,   1228}, {  884041,    0,    0} },
			{ 816000, { 1638816,  -65495,   1228}, {  900099,    0,    0} },
			{ 918000, { 1694532,  -67325,   1228}, {  918826,    0,    0} },
			{1020000, { 1752622,  -69115,   1228}, {  940222,    0,    0} },
			{1122000, { 1813084,  -70985,   1228}, {  964288,    0,    0} },
			{1224000, { 1875919,  -72815,   1228}, {  991023,    0,    0} },
			{1326000, { 1941126,  -74645,   1228}, { 1020427,    0,    0} },
			{1428000, { 2008707,  -76475,   1228}, { 1052500,    0,    0} },
			{1530000, { 2078660,  -78305,   1228}, { 1087244,    0,    0} },
			{1632000, { 2150986,  -80125,   1228}, { 1124896,    0,    0} },
			{1734000, { 2225685,  -81955,   1228}, { 1164978,    0,    0} },
			{1836000, { 2302756,  -83785,   1228}, { 1207729,    0,    0} },
			{1938000, { 2382200,  -85615,   1228}, { 1207729,    0,    0} },
			{2014500, { 2442937,  -86985,   1228}, { 1207729,    0,    0} },
			{      0, {      0,      0,   0}, {      0,    0,    0} },
		},
	}
};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",  -1, 1, KHZ,      201600, 201600, 201600, 211200, 211200, 211200, 710400, 710400, 787200, 806400),

	CORE_DVFS("3d",      -1, 1, KHZ,       96000,  96000,  96000, 105600, 105600, 105600, 576000, 576000, 633600, 710400),
	CORE_DVFS("2d",      -1, 1, KHZ,       96000,  96000,  96000, 105600, 105600, 105600, 576000, 576000, 633600, 710400),
	CORE_DVFS("epp",      -1, 1, KHZ,      96000,  96000,  96000, 105600, 105600, 105600, 576000, 576000, 633600, 710400),

	CORE_DVFS("se",      -1, 1, KHZ,       96000,  96000,  96000, 105600, 105600, 105600, 441600, 441600, 518400, 537600),
	CORE_DVFS("vde",      -1, 1, KHZ,      96000,  96000,  96000, 105600, 105600, 105600, 441600, 441600, 518400, 537600),

	CORE_DVFS("msenc",   -1, 1, KHZ,       72000,  72000,  72000,  77000,  77000,  77000, 360000, 360000, 408000, 408000),
	CORE_DVFS("tsec",    -1, 1, KHZ,      136000, 136000, 136000, 145000, 145000, 145000, 408000, 408000, 408000, 408000),
	CORE_DVFS("host1x",  -1, 1, KHZ,       81000,  81000,  81000,  86000,  86000,  86000, 384000, 384000, 384000, 384000),
	CORE_DVFS("vi",      -1, 1, KHZ,      110000, 110000, 110000, 118000, 118000, 118000, 408000, 408000, 408000, 408000),
	CORE_DVFS("isp",      -1, 1, KHZ,     110000, 110000, 110000, 118000, 118000, 118000, 408000, 408000, 408000, 408000),
	CORE_DVFS("sbus",    -1, 1, KHZ,      102000, 102000, 102000, 109000, 109000, 109000, 336000, 336000, 336000, 336000),

	CORE_DVFS("emc",     -1, 1, KHZ,           1,      1,      1,      1,      1,      1,1066000,1066000,1066000,1066000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c2bus",      -1, 1, KHZ,    96000,  96000,  96000, 105600, 105600, 105600, 576000, 576000, 633600, 710400),
	CORE_DVFS("c3bus",      -1, 1, KHZ,    96000,  96000,  96000, 105600, 105600, 105600, 441600, 441600, 518400, 537600),
#else
	CORE_DVFS("cbus",      -1, 1, KHZ,     96000,  96000,  96000, 105600, 105600, 105600, 441600, 441600, 518400, 537600),
#endif
	/* Core voltages (mV):		         800,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1250 */
	/* Clock limits for I/O peripherals */
	CORE_DVFS("csi",    -1, 1, KHZ,        75000,  75000,  75000,  75000,  75000,  84400, 102000, 102000, 102000, 102000),
	CORE_DVFS("cilab",  -1, 1, KHZ,       102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("cilcd",  -1, 1, KHZ,       102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("cile",  -1, 1, KHZ,        102000, 102000, 102000, 102000, 102000, 114700, 136000, 136000, 136000, 136000),
	CORE_DVFS("dsia",  -1, 1, KHZ,         75000,  75000,  75000,  75000,  86100, 105500, 125000, 125000, 125000, 125000),
	CORE_DVFS("dsib",  -1, 1, KHZ,         75000,  75000,  75000,  75000,  86100, 105500, 125000, 125000, 125000, 125000),
	CORE_DVFS("dsialp",  -1, 1, KHZ,       72000,  72000,  72000,  72000,  77500,  94900, 112500, 112500, 112500, 112500),
	CORE_DVFS("dsiblp",  -1, 1, KHZ,       72000,  72000,  72000,  72000,  77500,  94900, 112500, 112500, 112500, 112500),
	CORE_DVFS("hdmi",  -1, 1, KHZ,        111300, 111300, 111300, 135600, 173200, 212300, 270000, 270000, 270000, 270000),
	/*
	 ...
	 */
	CORE_DVFS("disp1",  -1, 0, KHZ,        74300,  74300,  74300,  88900, 113600, 139200, 165000, 165000, 165000, 165000),
	CORE_DVFS("disp2",  -1, 0, KHZ,        74300,  74300,  74300,  88900, 113600, 139200, 165000, 165000, 165000, 165000),
#endif
};
