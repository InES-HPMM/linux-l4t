...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",  -1, -1, 1, KHZ,      249600, 364800, 460800, 556800, 633600, 691200, 729600, 768000, 768000, 768000),

	CORE_DVFS("3d",      -1, -1, 1, KHZ,      153600, 230400, 307200, 422400, 499200, 556800, 595200, 652800, 691200, 710400),
	CORE_DVFS("2d",      -1, -1, 1, KHZ,      153600, 230400, 307200, 422400, 499200, 556800, 595200, 652800, 691200, 710400),
	CORE_DVFS("epp",     -1, -1, 1, KHZ,      153600, 230400, 307200, 422400, 499200, 556800, 595200, 652800, 691200, 710400),

	CORE_DVFS("se",      -1, -1, 1, KHZ,      115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
	CORE_DVFS("vde",     -1, -1, 1, KHZ,      115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),

	CORE_DVFS("msenc",   -1, -1, 1, KHZ,       68000, 102000, 136000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),
	CORE_DVFS("tsec",    -1, -1, 1, KHZ,      136000, 204000, 204000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	CORE_DVFS("host1x",  -1, -1, 1, KHZ,      102000, 102000, 204000, 204000, 204000, 204000, 384000, 408000, 408000, 408000),
	...
	CORE_DVFS("sbus",    -1, -1, 1, KHZ,      102000, 102000, 102000, 102000, 204000, 384000, 384000, 408000, 408000, 408000),

	CORE_DVFS("emc",     -1, -1, 1, KHZ,           1,      1,      1,      1,      1,      1,1066000,1066000,1066000,1066000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c2bus",   -1, -1, 1, KHZ,      153600, 230400, 307200, 422400, 499200, 556800, 595200, 652800, 691200, 710400),
	CORE_DVFS("c3bus",   -1, -1, 1, KHZ,      115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
#else
	CORE_DVFS("cbus",    -1, -1, 1, KHZ,      115200, 192000, 249600, 326400, 364800, 441600, 480000, 518400, 518400, 518400),
#endif
	/* Core voltages (mV):		             800,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1250 */
	...
	CORE_DVFS("pll_m",  -1, -1, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c",  -1, -1, 1, KHZ,       408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c2",  -1, -1, 1, KHZ,      408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	CORE_DVFS("pll_c3",  -1, -1, 1, KHZ,      408000, 667000, 800000,1066000,1066000,1066000,1066000,1066000,1066000,1066000),
	/*
