...
static __initdata struct tegra_pingroup_config dalmore_pinmux_set_nontristate[] = {
	DEFAULT_PINMUX(GPIO_X4_AUD,     SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_X5_AUD,     SAFE,   PULL_UP,      NORMAL,    INPUT),
	DEFAULT_PINMUX(GPIO_X7_AUD,     SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_W2_AUD,     SAFE,   PULL_UP,      NORMAL,    INPUT),
	...
	DEFAULT_PINMUX(GPIO_PV1,        SAFE,   NORMAL,       NORMAL,    INPUT),

	DEFAULT_PINMUX(GPIO_PBB3,       SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB5,       SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB6,       SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_PBB7,       SAFE,   PULL_DOWN,    NORMAL,    OUTPUT),
	...
	DEFAULT_PINMUX(HDMI_INT,        SAFE,  PULL_DOWN,    NORMAL,    INPUT),
