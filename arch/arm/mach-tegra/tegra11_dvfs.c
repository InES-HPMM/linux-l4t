...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",  0,  0, 1, KHZ,   228000, 306000, 396000, 528000,  648000,  696000,  696000,  696000),
	CORE_DVFS("cpu_lp",  0,  1, 1, KHZ,   468000, 480000, 612000, 696000,  696000,  696000,  696000,  696000),
	CORE_DVFS("cpu_lp",  1,  1, 1, KHZ,   468000, 480000, 612000, 714000,  792000,  816000,  816000,  816000),

	CORE_DVFS("sbus",    0,  0, 1, KHZ,        1, 188000, 240000, 276000,  324000,  336000,  336000,  336000),
	CORE_DVFS("sbus",    0,  1, 1, KHZ,        1, 264000, 300000, 336000,  336000,  336000,  336000,  336000),
	CORE_DVFS("sbus",    1,  1, 1, KHZ,        1, 264000, 300000, 336000,  372000,  384000,  384000,  384000),

	CORE_DVFS("vi",     -1,  0, 1, KHZ,   144000, 216000, 240000, 312000,  372000,  408000,  408000,  408000),
	CORE_DVFS("vi",     -1,  1, 1, KHZ,   240000, 294000, 360000, 408000,  408000,  408000,  408000,  408000),
	...
	CORE_DVFS("host1x",  0,  0, 1, KHZ,   144000, 188000, 240000, 276000,  324000,  336000,  336000,  336000),
	CORE_DVFS("host1x",  0,  1, 1, KHZ,   216000, 264000, 300000, 336000,  336000,  336000,  336000,  336000),
	CORE_DVFS("host1x",  1,  1, 1, KHZ,   216000, 264000, 300000, 336000,  372000,  384000,  384000,  384000),
