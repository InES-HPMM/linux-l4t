...
static struct pwm_fan_platform_data fan_data = {
	...
	.active_pwm = {0, 90*1024, 95*1024 , 100*1024, 105*1024, 110*1024,
				130*1024, 150*1024, 170*1024, 255*1024},
	.active_rru = {1024*90, 256, 256, 256, 256, 256, 128, 128, 128, 128},
	.active_rrd = {1024*90, 256, 256, 256, 256, 256, 256, 128, 128, 128},
	.pwm_period = 256,
	.pwm_id = 0,
	.step_time = 100, /*msecs*/
	.pwm_cap = 70,
