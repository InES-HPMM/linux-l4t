...
static struct dvfs core_dvfs_table[] = {
	...
	/* Clock limits for internal blocks, PLLs */
        ...
        CORE_DVFS("cpu_lp", -1, -1, 1, KHZ,   144000,   252000, 288000, 288000, 444000, 4440000, 624000, 624000),
        CORE_DVFS("sbus",   -1, -1, 1, KHZ,    81600,   102000, 136000, 136000, 204000,  204000, 204000, 204000),

	CORE_DVFS("vic03",  -1, -1, 1, KHZ,   120000,   144000, 168000, 168000, 216000,  216000, 372000, 372000),
	CORE_DVFS("tsec",   -1, -1, 1, KHZ,   120000,   144000, 168000, 168000, 216000,  216000, 372000, 372000),

	CORE_DVFS("msenc",  -1, -1, 1, KHZ,    72000,    84000, 102000, 102000, 180000,  180000, 252000, 252000),
	CORE_DVFS("se",     -1, -1, 1, KHZ,    72000,    84000, 102000, 102000, 180000,  180000, 252000, 252000),
	CORE_DVFS("vde",    -1, -1, 1, KHZ,    72000,    84000, 102000, 102000, 180000,  180000, 252000, 252000),

	CORE_DVFS("host1x", -1, -1, 1, KHZ,    81600,   102000, 136000, 136000, 163000,  163000, 204000, 204000),

	CORE_DVFS("vi",     -1, -1, 1, KHZ,   120000,   156000, 182000, 182000, 312000,  312000, 444000, 444000),
	CORE_DVFS("isp",    -1, -1, 1, KHZ,   120000,   156000, 182000, 182000, 312000,  312000, 444000, 444000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c2bus",  -1, -1, 1, KHZ,    72000,    84000, 102000, 102000, 180000,  180000, 252000, 252000),
	CORE_DVFS("c3bus",  -1, -1, 1, KHZ,   120000,   144000, 168000, 168000, 216000,  216000, 372000, 372000),
#else
	CORE_DVFS("cbus",   -1, -1, 1, KHZ,   120000,   144000, 168000, 168000, 216000,  216000, 372000, 372000),
#endif
	CORE_DVFS("c4bus",  -1, -1, 1, KHZ,   120000,   156000, 182000, 182000, 312000,  312000, 444000, 444000),
	...
	CORE_DVFS("sbc1",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),
	CORE_DVFS("sbc2",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),
	CORE_DVFS("sbc3",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),
	CORE_DVFS("sbc4",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),
	CORE_DVFS("sbc5",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),
	CORE_DVFS("sbc6",   -1, -1, 1, KHZ,    24000,  24000,  48000,  48000,   48000,  48000,  48000,  48000),

	CORE_DVFS("sdmmc1", -1, -1, 1, KHZ,   102000, 102000, 163200, 163200,  163200, 163200, 163200, 163200),
	CORE_DVFS("sdmmc3", -1, -1, 1, KHZ,   102000, 102000, 163200, 163200,  163200, 163200, 163200, 163200),
	CORE_DVFS("sdmmc4", -1, -1, 1, KHZ,   102000, 102000, 178200, 178200,  178200, 178200, 178200, 178200),

	CORE_DVFS("hdmi",   -1, -1, 1, KHZ,    99000, 118800, 148500, 148500,  198000, 198000, 198000, 198000),
	 ...
	 */
	CORE_DVFS("disp1",  -1, -1, 0, KHZ,   108000, 120000, 144000, 144000, 297000,  297000, 474000, 474000),
	CORE_DVFS("disp2",  -1, -1, 0, KHZ,   108000, 120000, 144000, 144000, 297000,  297000, 474000, 474000),

	/* Core voltages (mV):		         	800,    850,    900,	 950,    1000,	1050,    1100,	 1150 */
	/* xusb clocks */
	CORE_DVFS("xusb_falcon_src", -1, -1, 1, KHZ,  204000, 204000, 204000, 204000, 336000, 336000,  336000,  336000),
	CORE_DVFS("xusb_host_src",   -1, -1, 1, KHZ,   58300,  58300,  58300,  58300, 112000, 112000,  112000,  112000),
	CORE_DVFS("xusb_dev_src",    -1, -1, 1, KHZ,   58300,  58300,  58300,  58300, 112000, 112000,  112000,  112000),
	CORE_DVFS("xusb_ss_src",     -1, -1, 1, KHZ,   60000,  60000,  60000,  60000, 120000, 120000,  120000,  120000),
