...
static struct dvfs core_dvfs_table_automotive[] = {
	...
	CORE_DVFS("cpu_lp",     2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 948000,  948000),
	CORE_DVFS("sbus",       2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 282000,  282000),

	CORE_DVFS("vic03",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 564000,  564000),
	CORE_DVFS("tsec",       2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 564000,  564000),
	CORE_DVFS("msenc",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 372000,  372000),
	CORE_DVFS("se",         2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 372000,  372000),
	CORE_DVFS("vde",        2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 450000,  450000),

	CORE_DVFS("host1x",     2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 282000,  282000),
	CORE_DVFS("vi",         2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 600000,  600000),
	CORE_DVFS("isp",        2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 600000,  600000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c2bus",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 372000,  372000),
	CORE_DVFS("c3bus",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 450000,  450000),
#else
	CORE_DVFS("cbus",      -1, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 564000,  564000),
#endif

	CORE_DVFS("c4bus",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 600000,  600000),
	CORE_DVFS("pll_m",	2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 792000,  792000),
	CORE_DVFS("pll_c",      2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 564000,  564000),
	CORE_DVFS("pll_c2",     2, -1, 1, KHZ,       1,      1,      1,      1,      1,      1,      1, 372000,  372000),
	CORE_DVFS("pll_c3",  2, -1, 1, KHZ,          1,      1,      1,      1,      1,      1,      1, 450000,  450000),

	/* Core voltages (mV):		         800,    850,    900,	 950,    1000,	1050,    1100,	 1110,  1150 */
	/* Clock limits for I/O peripherals */
	CORE_DVFS("sbc1",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),
	CORE_DVFS("sbc2",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),
	CORE_DVFS("sbc3",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),
	CORE_DVFS("sbc4",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),
	CORE_DVFS("sbc5",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),
	CORE_DVFS("sbc6",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1,  51000, 51000),

	CORE_DVFS("hdmi",    2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1, 297000, 297000),
	/* FIXME: Finalize these values for NOR after qual */
	CORE_DVFS("nor",     2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1, 102000, 102000),
	CORE_DVFS("pciex",   2,  -1, 1, KHZ,       1,      1,      1,      1,       1,      1,      1, 500000, 500000),
	CORE_DVFS("mselect", 2, -1, 1, KHZ,        1,      1,      1,      1,       1,      1,      1, 408000, 408000),

	/* Core voltages (mV):		         	800,    850,    900,	 950,    1000,	1050,    1100,	 1110,   1150 */
	/* xusb clocks */
	CORE_DVFS("xusb_falcon_src",  2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,  336000, 336000),
	CORE_DVFS("xusb_host_src",    2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,  112000, 112000),
	CORE_DVFS("xusb_dev_src",     2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,  112000, 112000),
	CORE_DVFS("xusb_ss_src",      2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,  120000, 120000),
	CORE_DVFS("xusb_fs_src",      2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,   48000, 48000),
	CORE_DVFS("xusb_hs_src",      2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,   60000, 60000),

	CORE_DVFS("hda",              2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,   48000,  48000),
	CORE_DVFS("hda2codec_2x",     2, -1, 1, KHZ,    1,      1,      1,      1,      1,      1 ,       1,   48000, 48000),
};
