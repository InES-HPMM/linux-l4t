/*
 * arch/arm64/mach-tegra/board-t210ref.h
 *
...
int t210ref_emc_init(void);
int t210ref_display_init(void);
int t210ref_panel_init(void);
int t210ref_sdhci_init(void);
int t210ref_sensors_init(void);
int t210ref_regulator_init(void);
int t210ref_suspend_init(void);
int t210ref_rail_alignment_init(void);
int t210ref_soctherm_init(void);
int t210ref_edp_init(void);
void shield_new_sysedp_init(void);
void shield_sysedp_dynamic_capping_init(void);
void shield_sysedp_batmon_init(void);
void t210ref_camera_auxdata(void *);
...
#define TOUCH_SPI_ID			0	/*SPI 1 on t210ref_interposer*/
#define TOUCH_SPI_CS			0	/*CS  0 on t210ref_interposer*/
...
/*Below GPIO's are same for Laguna and T210ref*/
