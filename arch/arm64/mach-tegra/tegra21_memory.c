...
#define TEGRA_DEBUG_EMC_DVFS_IN_KERNEL 0

#if TEGRA_DEBUG_EMC_DVFS_IN_KERNEL
static struct tegra21_emc_table t210_emc_table_granada[] = {
	{
		0x18,       /* V5.0.12 */
...
static struct tegra21_emc_pdata t210_emc_pdata_granada = {
	.description = "ardbeg_emc_tables",
	.tables = t210_emc_table_granada,
	.num_tables = ARRAY_SIZE(t210_emc_table_granada),
};
#endif

int __init t210_emc_init(void)
{
#if TEGRA_DEBUG_EMC_DVFS_IN_KERNEL
	tegra_emc_device.dev.platform_data = &t210_emc_pdata_granada;
